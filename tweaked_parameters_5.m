...
parameters('alpha_p_TF') = 10^(-0.0585); % Got from simulation_tune_sequential_activator_cre
parameters('delta_TF') = 10^(-3.1); % Got from simulation_tune_sequential_activator_cre
...
parameters('alpha_p_Cre') = 10^(1.5186); % Got from simulation_tune_sequential_activator_cre
