function [time_interval, y_out, y] = Chain_Cre_TF_Repressor_Cre_off_Kill_Switch(time_span, parameters, initial, step)
...
function dx=diff_eq(t, x, parameters)
	...
	d_TF =  alpha_p_TF*(Cre_regulated_region/AAV)*AAV - delta_TF*TF;
