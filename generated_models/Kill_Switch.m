function [time_interval, y_out, y] = Kill_Switch(time_span, parameters, initial, step)
...
function dx=diff_eq(t, x, parameters)
    ...
    dx = max(-x,real([d_AAV, d_Cas9, d_Cas9_sgRNA1, d_Cas9_sgRNA2, d_edited_genome, d_genome, d_postedit_Cas9_sgRNA1, d_postedit_Cas9_sgRNA2, d_sgRNA1, d_sgRNA2])');
end
