function [time_interval, y_out, y] = Joint_Activator_Repressor_Kill_Switch(time_span, parameters, initial, step)
...
function dx=diff_eq(t, x, parameters)
	...
	d_sgRNA1 =  alpha_r_sgRNA1*(K_R^n)/(K_R^n + TF2^n)*(TF^n)/(K_A^n + TF^n)*AAV - Cas_gRNA_binding*Cas9*sgRNA1 - delta_g*sgRNA1;
