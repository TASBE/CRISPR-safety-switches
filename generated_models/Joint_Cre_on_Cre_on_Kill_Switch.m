function [time_interval, y_out, y] = Joint_Cre_on_Cre_on_Kill_Switch(time_span, parameters, initial, step)
...
function dx=diff_eq(t, x, parameters)
	...
	d_CreH =  alpha_p_CreH*AAV - delta_CreH*CreH;
	...
	d_sgRNA1 =  alpha_r_sgRNA1*(edited_Cre_regulated_region/AAV)*(edited_CreH_regulated_region/AAV)*AAV - Cas_gRNA_binding*Cas9*sgRNA1 - delta_g*sgRNA1;
