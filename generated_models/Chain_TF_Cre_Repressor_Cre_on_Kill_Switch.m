function [time_interval, y_out, y] = Chain_TF_Cre_Repressor_Cre_on_Kill_Switch(time_span, parameters, initial, step)
...
function dx=diff_eq(t, x, parameters)
	...
	d_Cre =  alpha_p_Cre*(K_R^n)/(K_R^n + TF^n)*AAV - delta_Cre*Cre;
