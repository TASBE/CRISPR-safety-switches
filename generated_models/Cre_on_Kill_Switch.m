...
function dx=diff_eq(t, x, parameters)
	...
	edited_Cre_regulated_region = x(7);
	edited_genome = x(8);
	genome = x(9);
	postedit_Cas9_sgRNA1 = x(10);
	postedit_Cas9_sgRNA2 = x(11);
	sgRNA1 = x(12);
	sgRNA2 = x(13);
	...
	d_sgRNA1 =  alpha_r_sgRNA1*(edited_Cre_regulated_region/AAV)*AAV - Cas_gRNA_binding*Cas9*sgRNA1 - delta_g*sgRNA1;
    ...
    dx = max(-x,real([d_AAV, d_Cas9, d_Cas9_sgRNA1, d_Cas9_sgRNA2, d_Cre, d_Cre_regulated_region, d_edited_Cre_regulated_region, d_edited_genome, d_genome, d_postedit_Cas9_sgRNA1, d_postedit_Cas9_sgRNA2, d_sgRNA1, d_sgRNA2])');
end
