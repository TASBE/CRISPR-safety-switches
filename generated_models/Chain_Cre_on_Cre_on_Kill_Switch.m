function [time_interval, y_out, y] = Chain_Cre_on_Cre_on_Kill_Switch(time_span, parameters, initial, step)
...
function dx=diff_eq(t, x, parameters)
	...
	d_CreH =  alpha_p_CreH*(edited_Cre_regulated_region/AAV)*AAV - delta_CreH*CreH;
	...
	d_sgRNA1 =  alpha_r_sgRNA1*(edited_CreH_regulated_region/AAV)*AAV - Cas_gRNA_binding*Cas9*sgRNA1 - delta_g*sgRNA1;
    ...
    dx = real([d_AAV, d_Cas9, d_Cas9_sgRNA1, d_Cas9_sgRNA2, d_Cre, d_CreH, d_CreH_regulated_region, d_Cre_regulated_region, d_edited_CreH_regulated_region, d_edited_Cre_regulated_region, d_edited_genome, d_genome, d_postedit_Cas9_sgRNA1, d_postedit_Cas9_sgRNA2, d_sgRNA1, d_sgRNA2])';
end
