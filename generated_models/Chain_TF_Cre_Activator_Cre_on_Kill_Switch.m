function [time_interval, y_out, y] = Chain_TF_Cre_Activator_Cre_on_Kill_Switch(time_span, parameters, initial, step)
...
function dx=diff_eq(t, x, parameters)
	...
	d_Cre =  alpha_p_Cre*(TF^n)/(K_A^n + TF^n)*AAV - delta_Cre*Cre;
