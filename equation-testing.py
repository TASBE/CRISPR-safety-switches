# Not sure I need all of these packages, I just took everything Jake used in his script
import logging
import os
...
#### Run ####
doc = sbol3.Document()
doc.read('210919_try01.nt')

# For each system in the document, generate a matlab model
with open(os.path.join('generated_models', 'generated_equations_test01.tex'), 'w') as out:
